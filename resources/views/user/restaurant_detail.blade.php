                ...
                <div class="card-body">
                    ...
                    <table class="table table-dark">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($data->restaurant_ratings == '1')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star" ></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i><sub> (From Many Users)</sub>
                                @elseif ($data->restaurant_ratings == '2')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning " ></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i><sub> From Many Users)</sub>
                                @elseif ($data->restaurant_ratings == '3')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning " ></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star "></i>
                                <i class="bx bx-star "></i><sub> (From Many Users)</sub>
                                @elseif ($data->restaurant_ratings == '4')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star "></i> <sub>(From Many Users)</sub>
                                @elseif ($data->restaurant_ratings == '5')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning " ></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                        ...
                        <tr>
                            <td>
                                <h5><i class="bx bx-time"> </i> Number Of Tables:</h5>
                            </td>
                            <td>
                                @if ($data->number_of_tables == 'more_then_five')
                                <h5>More then 5</h5>
                                @elseif ($data->number_of_tables == 'more_then_fifteen')
                                <h5>More then 15</h5>
                                @elseif ($data->number_of_tables == 'more_then_twentyfive')
                                <h5>More then 25</h5>
                        ...
                        <tr>
                            <td>
                                <h5><i class="bx bx-phone"> </i> Restaurant Contact Number:</h5>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <br>
                                <h5><i class="bx bx-detail"> </i> Restaurant Description:</h5>
                            </td>
                            <td>
