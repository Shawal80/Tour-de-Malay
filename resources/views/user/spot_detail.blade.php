                ...
                <div class="card-body">
                    ...
                    <table class="table table-dark">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($data->spot_ratings == '1')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star" ></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i><sub> (From Many Users)</sub>
                                @elseif ($data->spot_ratings == '2')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning " ></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i><sub> (From Many Users)</sub>
                                @elseif ($data->spot_ratings == '3')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning " ></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star "></i>
                                <i class="bx bx-star "></i><sub> (From Many Users)</sub>
                                @elseif ($data->spot_ratings == '4')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star "></i> <sub>(From Many Users)</sub>
                                @elseif ($data->spot_ratings == '5')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning " ></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                        ...
                        <tr>
                            <td>
                                <br>
                                <h5><i class="bx bx-detail"> </i> Destination Description:</h5>
                            </td>
                            <td>
                               <p>{{$data->spot_description}}</p>
                            </td>
                        </tr>
