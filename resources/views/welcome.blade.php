                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="small-box bg-info">
                                ...
                                <a href="{{url('hotels')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3>{{$totalRestaurant ?? ''  }}</h3>
                                ...
                                <a href="{{url('restaurants')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                        </div>
                        <div class="col-sm-3">
