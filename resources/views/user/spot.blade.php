    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="{{url('all-spots')}}">Destinations</a></li>
...
<section id="hero">
    <div class="hero-container" data-aos="fade-up">
      <h1>The capital of Malaysia is widely recognized for numerous landmarks here are the list of some famouse landmarks in <span style="color: lightgreen">Kuala Lumpur</span> </h1>
    </div>
  </section><!-- End Hero -->
  <!-- ======= Team Section ======= -->
        ...
        <div class="col-sm-4 d-flex align-items-stretch">
            <div class="member  bg-dark" data-aos="fade-up">
                ...
                <div class="member-info">
                    <p class="text-light">Name :  {{$spot->name}}</p>
                    <p class="text-light"> Address : {{$spot->address}}</p>
                    <p class="text-light"> Rattings :
                    @if ($spot->spot_ratings == '1')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star" ></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    @elseif ($spot->spot_ratings == '2')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning " ></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    @elseif ($spot->spot_ratings == '3')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning " ></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star "></i>
                    <i class="bx bx-star "></i>
                    @elseif ($spot->spot_ratings == '4')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star "></i>
                    @elseif ($spot->spot_ratings == '5')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning " ></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    ...
                    <a href="{{url('spot-detail',$spot->id)}}" class="btn btn-outline-success"> See More </a>
                </div>
            </div>
        </div>
        @endforeach
