    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="#team">Clubs</a></li>
...
<section id="hero">
    <div class="hero-container" data-aos="fade-up">
      <h1>Find Out the Most Recommended and <span style="color: lightgreen"> Clubbing </span>culture in<span style="color: lightgreen">Kuala Lumpur</span> </h1>
    </div>
  </section><!-- End Hero -->
  <!-- ======= Team Section ======= -->
        ...
        <div class="col-sm-4 d-flex align-items-stretch">
            <div class="member  bg-dark" data-aos="fade-up">
                <div class="member-img ">
                    <img src="{{asset('frontend/assets/img/bar.png')}}" class="img-fluid" alt="">

                </div>
                <div class="member-info">
                    <p class="text-light">Name :  {{$club->name}}</p>
                    <p class="text-light"> Address : {{$club->address}}</p>
                    <p class="text-light"> Rattings :
                    @if ($club->club_ratings == '1')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star" ></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    @elseif ($club->club_ratings == '2')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning " ></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    @elseif ($club->club_ratings == '3')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning " ></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star "></i>
                    <i class="bx bx-star "></i>
                    @elseif ($club->club_ratings == '4')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star "></i>
                    @elseif ($club->club_ratings == '5')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning " ></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    ...
                    <a href="{{url('club-detail',$club->id)}}" class="btn btn-outline-success"> See More </a>
                </div>
            </div>
        </div>
        @endforeach
