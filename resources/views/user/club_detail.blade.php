    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="{{url('all-clubs')}}">Clubs</a></li>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-dark">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($data->club_ratings == '1')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star" ></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i><sub> (From Many Users)</sub>
                                @elseif ($data->club_ratings == '2')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning " ></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i>
                                <i class="bx bx-star"></i><sub> (From Many Users)</sub>
                                @elseif ($data->club_ratings == '3')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning " ></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star "></i>
                                <i class="bx bx-star "></i><sub> (From Many Users)</sub>
                                @elseif ($data->club_ratings == '4')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star "></i> <sub>(From Many Users)</sub>
                                @elseif ($data->club_ratings == '5')
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning " ></i>
                                <i class="bx bx-star text-warning"></i>
                                <i class="bx bx-star text-warning"></i>
                        ...
                        <tr>
                            <td>
                                <h5><i class="bx bx-time"> </i> Opens At:</h5>
                            </td>
                            <td>
                               <h5>{{$data->opens_at}} : PM <sub>(malaysian local time)</sub></h5>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h5><i class="bx bx-time"> </i> Close At:</h5>
                            </td>
                            <td>
                               <h5>{{$data->close_at}} : AM  <sub>(malaysian local time)</sub></h5>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <br>
                                <h5><i class="bx bx-detail"> </i> Club Description:</h5>
                            </td>
                            <td>
