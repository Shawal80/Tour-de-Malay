          ...
          <div class="row">
            ...
            <div class="col-sm-12">
                <div class="box-heading" data-aos="fade-up">
                    <h4>About us</h4>
                    <h3>Tour De Malay</h3>
                    <p>I have created this website for the visitors and tourists, in <span>Kuala Lumpur</span>. our site contains major information about the tourism destinations, highly recommended hotels,restaurants and clubbing culture of the city.</p>
                  </div>

                  <div class="icon-box" data-aos="fade-up">
                    <div class="icon"><i class="bx bx-arch"></i></div>
                    <h4 class="title"><a href="">Hotels</a></h4>
                    <p class="description">Most recommended hotels for stay</p>
                  </div>

                  <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                    <div class="icon"><i class="bx bx-restaurant"></i></div>
                    <h4 class="title"><a href="">Restaurants</a></h4>
                    <p class="description">Mouth watering food restaurants in city</p>
                  </div>

                  <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                    <div class="icon"><i class="bx bx-map"></i></div>
                    <h4 class="title"><a href="">Destinations</a></h4>
                    <p class="description">Most visited Tourists Spots Details</p>
                  </div>
                  <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                    <div class="icon"><i class="bx bx-party"></i></div>
                    <h4 class="title"><a href="">Clubs</a></h4>
                    <p class="description">Most visited  Clubs In the City</p>
                  </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-2 d-flex align-items-stretch">
                ...
                <div class="member-img">
                  <img src="{{asset('frontend\assets\img\testimonials\testimonials-1.png')}}" class="testimonial-img" alt="">
                  <div class="social">
