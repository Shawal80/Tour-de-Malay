...
<section class="content">
    <div class="content-header">
        ...
        <div class="row mb-2 mt-2">
            <div class="col-sm-12">
                <a href="{{route('hotels.create')}}" class="btn btn-success text-white float-right">Add Hotel</a>
            </div>
        </div>
        {{-- MAIN CONTENT --}}
        <hr>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                </button>  <form action="{{url('hotels',$item['id'])}}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    ...
                                    <div class="modal fade" id="modal-primary{{$item['id']}}" style="display: none;" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{url('hotels',$item['id'])}}" method="POST" id="hotel_detail_form" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group input-material">
                                                                ...
                                                                <textarea id="hotel_description" name="hotel_description" class="form-control" rows="1">{{$item['hotel_description']}}</textarea>
