        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Hotels/Restaurants</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="{{url('all-clubs')}}">Restaurants</a></li>
            </ul>
          </li>
        </ul>
...
<section id="hero">
    <div class="hero-container" data-aos="fade-up">
      <h1>Find Out the Most Recommended and High Rated <span style="color: lightgreen">Hotels</span>  in <span style="color: lightgreen">Kuala Lumpur</span> </h1>
    </div>
  </section><!-- End Hero -->
  <!-- ======= Team Section ======= -->
        ...
        <div class="col-sm-4 d-flex align-items-stretch">
            <div class="member  bg-dark" data-aos="fade-up">
                <div class="member-img ">
                    <img src="{{asset('frontend/assets/img/hotel.png')}}" class="img-fluid" alt="">

                </div>
                <div class="member-info">
                    <p class="text-light">Name :  {{$hotels->name}}</p>
                    <p class="text-light"> Address : {{$hotels->address}}</p>
                    <p class="text-light"> Rattings :
                    @if ($hotels->hotel_ratings == '1')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star" ></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    @elseif ($hotels->hotel_ratings == '2')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning " ></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    <i class="bx bx-star"></i>
                    @elseif ($hotels->hotel_ratings == '3')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning " ></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star "></i>
                    <i class="bx bx-star "></i>
                    @elseif ($hotels->hotel_ratings == '4')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star "></i>
                    @elseif ($hotels->hotel_ratings == '5')
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning " ></i>
                    <i class="bx bx-star text-warning"></i>
                    <i class="bx bx-star text-warning"></i>
                    ...
                    <a href="{{url('hotel-detail',$hotels->id)}}" class="btn btn-outline-success"> See More </a>
                </div>
            </div>
        </div>
        @endforeach
